...
const Landing = () => {
  const features = [
    {
      ...
      description:
        "Advanced machine learning models analyze your code for potential bugs and risks.",
    },
    {
      icon: Shield,
      title: "Risk Prediction",
      description:
        "Get detailed risk scores and identify problematic areas before they cause issues.",
    },
    {
      icon: Zap,
      title: "Lightning Fast",
      description:
        "Instant analysis with real-time feedback and actionable insights.",
    },
    {
      icon: BarChart3,
      title: "Detailed Metrics",
      description:
        "Comprehensive code metrics including complexity, nesting depth, and more.",
    },
  ];
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ color: "#4b5563" }}
              >
                Defect-Prone Software Analysis
              </span>
            </motion.h1>
            ...
            >
              ...
              assess code quality, and predict risks before they impact your
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#4b5563" }}
            >
              Built with the latest AI research to help developers write better,
              more reliable code.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl mb-8" style={{ color: "#4b5563" }}>
                CodeSage integrates seamlessly into your existing workflow,
                providing actionable insights that help you ship better code
                faster.
              </p>
            ...
            >
              <div
                className="aspect-w-16 aspect-h-9 rounded-2xl shadow-2xl"
                style={{
                  background:
                    "linear-gradient(to bottom right, #336699, #86bbd8)",
                }}
              >
      ...
      <section
        className="py-20"
        style={{ background: "linear-gradient(to right, #336699, #86bbd8)" }}
      >
