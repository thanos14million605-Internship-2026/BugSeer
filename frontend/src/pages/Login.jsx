...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style={{ background: 'linear-gradient(to bottom right, #faf7ee, #dcf9fe)' }}>
      <motion.div
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  style={{ color: '#336699' }}
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm" style={{ color: '#2f4858' }}>
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-medium hover:underline" style={{ color: '#336699' }}>
